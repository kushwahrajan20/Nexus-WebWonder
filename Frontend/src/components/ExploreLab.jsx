    ...
    <>
      <div className=''>
        ...
        <div className='h-10 mt-14 fixed  navbar bg-green-800'>
          <h1 className='text-4xl text-white mx-auto mt-2'>Virtual Tour - Explore <span className='ml-3 text-green-600'>{typeEffect}</span><span className='text-green-600'>!</span></h1>
        </div>
        ...
        <div className='w-44 h-screen fixed left-0 bg-white'>
          ...
          <div className='text-center transform transition-all hover:-translate-y-2 duration-300 hover:shadow-2xl'>
            <div className='bg-[url("https://tse3.mm.bing.net/th?id=OIP.eTODXiMmtE0Yk_roceCyPQHaE7&pid=Api&P=0&h=180")] w-40 h-24 mt-24 mx-auto text-white'
          ...
          <div className='text-center transform transition-all hover:-translate-y-2 duration-300 hover:shadow-2xl'>
            <div className='bg-[url("https://tse2.mm.bing.net/th?id=OIP.Xp15iZ3nKy1g0E5ksUJVxwHaE7&pid=Api&P=0&h=180")] w-40 h-24 mt-2 mx-auto text-white'
          ...
          <div className='text-center transform transition-all hover:-translate-y-2 duration-300 hover:shadow-2xl'>
            <div className='bg-[url("https://tse3.mm.bing.net/th?id=OIP._pIyWAOLFy0xB_tJgBrFsgHaE7&pid=Api&P=0&h=180")] w-40 h-24 mt-2 mx-auto text-white'
          ...
          <div className='text-center transform transition-all hover:-translate-y-2 duration-300 hover:shadow-2xl'>
            <div className='bg-[url("https://tse3.mm.bing.net/th?id=OIP.R9cXQhnkwy0klgLly00MngHaE7&pid=Api&P=0&h=180")] w-40 h-24 mt-2 mx-auto text-white'
          ...
          <div className='text-center transform transition-all hover:-translate-y-2 duration-300 hover:shadow-2xl'>
            <div className='bg-[url("https://tse2.mm.bing.net/th?id=OIP.22kr41SVddiDYs_v_3q8VwHaEN&pid=Api&P=0&h=180")] w-40 h-24 mt-2 mx-auto text-white'
          ...
          <div className='text-center transform transition-all hover:-translate-y-2 duration-300 hover:shadow-2xl'>
            <div className='bg-[url("https://tse4.mm.bing.net/th?id=OIP.M5WYHu69tlMWVvgpxrKbJgHaEZ&pid=Api&P=0&h=180")] w-40 h-24 mt-2 mx-auto text-white'
        ...
        <div className='w-44 h-screen fixed right-0 bg-white'>
          ...
          <div className='text-center transform transition-all hover:-translate-y-2 duration-300 hover:shadow-2xl'>
            <div className='bg-[url("https://tse4.mm.bing.net/th?id=OIP.acc9qgyyReEd85Ir-XA09AHaEK&pid=Api&P=0&h=180")] w-40 h-24 mt-24 mx-auto text-white'
          ...
          <div className='text-center transform transition-all hover:-translate-y-2 duration-300 hover:shadow-2xl'>
            <div className='bg-[url("https://tse3.mm.bing.net/th?id=OIP.XG8vrH1EBfmXJ91Q5WHMJAHaEq&pid=Api&P=0&h=180")] w-40 h-24 mt-2 mx-auto text-white'
          ...
          <div className='text-center transform transition-all hover:-translate-y-2 duration-300 hover:shadow-2xl'>
            <div className='bg-[url("https://tse3.mm.bing.net/th?id=OIP.pdFMJa2WFDYElkvf7RUC3wHaFj&pid=Api&P=0&h=180")] w-40 h-24 mt-2 mx-auto text-white'
          ...
          <div className='text-center transform transition-all hover:-translate-y-2 duration-300 hover:shadow-2xl'>
            <div className='bg-[url("https://tse3.mm.bing.net/th?id=OIP.q8fO78sDQHKJQ6JjNFpyKQHaFc&pid=Api&P=0&h=180")] w-40 h-24 mt-2 mx-auto text-white'
          ...
          <div className='text-center transform transition-all hover:-translate-y-2 duration-300 hover:shadow-2xl'>
            <div className='bg-[url("https://tse1.mm.bing.net/th?id=OIP.WFv773qr-NBl6O38YIIS7wHaE8&pid=Api&P=0&h=180")] w-40 h-24 mt-2 mx-auto text-white'
          ...
          <div className='text-center transform transition-all hover:-translate-y-2 duration-300 hover:shadow-2xl'>
            <div className='bg-[url("https://tse2.mm.bing.net/th?id=OIP.yF18Eu1DlnNHN62LyKMD1AHaE7&pid=Api&P=0&h=180")] w-40 h-24 mt-2 mx-auto text-white'
